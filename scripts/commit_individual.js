 ...
 * each modified/new/deleted file to maximize GitHub contribution count.
 *
 * Usage:
 *   node scripts/commit_individual.js              # dry-run mode
 *   node scripts/commit_individual.js --confirm    # actually commit and push
 */
...
async function main() {
  ...
  console.log('Individual Commit Script');
  ...
  for (let i = 0; i < changedFiles.length; i++) {
    ...
    // Scan for secrets (skip script files as they may contain regex patterns)
  ...
  if (DRY_RUN) {
    ...
    console.log('  node scripts/commit_individual.js --confirm');
  } else {
